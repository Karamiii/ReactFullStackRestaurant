  ...
  useEffect(() => {
    const fetchOrderAndDishes = async () => {
      try {
        ...
        const orderResponse = await axios.get(`https://reactdine-api.onrender.com/api/orders/${orderId}`);
        setOrder(orderResponse.data);

        // Fetch the list of all dishes
        const dishesResponse = await axios.get('https://reactdine-api.onrender.com/api/dishes');
        ...
        {order.items.map((item, index) => {
          ...
          return (
            <div key={index} className="order-item">
              ...
              <img
                src={`https://reactdine-api.onrender.com/${dishDetails?.image}`}
